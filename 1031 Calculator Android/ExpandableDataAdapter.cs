...
namespace _1031_Calculator
{
    public class ExpandableDataAdapter : BaseExpandableListAdapter
    {
        ...
        public ExpandableDataAdapter(Activity newContext, List<AboutData> newList) : base()
        {
            Context = newContext;
            DataList = newList;
        }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            header.FindViewById<TextView>(Resource.Id.DataHeader).Text = DataList[groupPosition].Question;
